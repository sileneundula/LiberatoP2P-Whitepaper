...
**Project-Name:** `BeeHiveRegistry`

**Part-Of-Projects:** `OpenInternet`, `SumatraChain`, `LiberatoP2P`, `MuscarineP2P`
...
## Standard (X59 Certificate Format)

The X59 Certificate Format is used for addressing.
